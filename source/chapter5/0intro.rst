...
在正式开始这一章的介绍之前，我们很高兴告诉同学：在前面的章节中基本涵盖了一个功能相对完善的操作系统内核所需的核心硬件机制：中断、特权级、页表，而且我们的应用程序在开发方面也越来越便捷了。但开发者的需求是无穷的，开发者希望能够在操作系统启动后，能灵活选择执行某个程序，但我们目前实现的操作系统还无法支持这样的功能。这说明操作系统还缺少对应用程序动态执行的灵活性和交互性的支持！
