...
<<<<<<< HEAD:source/chapter2/0intro.rst
**本章导读**
---------------------------------
...
本章导读
-----------------------------
>>>>>>> wyf:source/chapter2/0intro.rst
...
=======
实际上，这样做是一种对于珍贵的计算资源的浪费。因为当时的计算机和今天的个人计算机不同，它的体积极其庞大，能够占满一整个空调房间，象巨大的恐龙。
>>>>>>> wyf:source/chapter2/0intro.rst
...
---------------------------
=======
本章主要是设计和实现建立支持 **批处理系统** 的“敏迷龙”操作系统，从而对可支持运行一批应用程序的执行环境有一个全面和深入的理解。

本章我们的目标让“敏迷龙”操作系统能够感知多个应用程序的存在，并一个接一个地运行这些应用程序，当一个应用程序执行完毕后，会启动下一个应用程序，
直到所有的应用程序都执行完毕。
